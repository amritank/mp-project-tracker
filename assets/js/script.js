...
function createProjectCard(project) {
  ...
  const cardDivEl = $("<div>");
  cardDivEl.addClass("card project-card draggable my-3");
  cardDivEl.attr("data-project-id", project.id);
  ...
  dateParaEl.text(project.dueDate);
  ...
  buttonEl.attr("data-project-id", project.id);
    ...
    for (let project of projects) {
      if (project !== null) {
        ...
        if (project.status === "to-do") {
          todoContainerEl.append(cardEl);
        } else if (project.status === "in-progress") {
          inProgressContainerEl.append(cardEl);
        } else {
          doneContainerEl.append(cardEl);
        }
      }
    }
  }
